...
<img alt="Conceptual illustration of reference frames." src="../figures/overview/reference_frames_illustration.png" style="width: 50%; float: right; margin-left: 20px; margin-bottom: 20px">
